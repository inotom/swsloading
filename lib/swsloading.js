...
},{"./swsloading.js":"swsloading"}],"swsloading":[function(require,module,exports){
...
module.exports = {
  oninit: function(vnode) {
    ...
    if (vnode.attrs.pathes) {
      pathes = vnode.attrs.pathes;
    } else {
